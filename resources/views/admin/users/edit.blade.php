                  ...
                  <form class="form theme-form" method="POST" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                          <input class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" id="exampleFormControlInput1" type="text" placeholder="البريد الالكتروني">
                          @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
