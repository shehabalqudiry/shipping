    ...
    <div class="row bg-light">
        <div class="d-flex flex-column flex-shrink-0" style="width: 220px;height:100vh">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                <span class="fs-4">{{ __('Account') }}</span>
            </a>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="{{ route('front.user.account') }}" class="nav-link link-dark @yield('active1')">
                        {{ __('Account Details') }}
                    </a>
                </li>
                 <li>
                    <a href="{{ route('front.user.teams') }}" class="nav-link link-dark @yield('active2')">
                        {{ __('Team Members') }}
                    </a>
                </li>
                <li>
                    <a href="{{ route('front.user.documents') }}" class="nav-link link-dark @yield('active3')">
                        {{ __('Documents') }}
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('front.user.localPrice') }}" class="nav-link link-dark @yield('active7')">
                        {{ __('Local Price') }}
                    </a>
                </li>
            </ul>
